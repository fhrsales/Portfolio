import"../chunks/Bzak7iHL.js";import"../chunks/CKArZUO8.js";import{p as j,s as t,n as v,o as P,c as S,f as z,h as l,a as I,q as M,t as _}from"../chunks/Dru1obsd.js";import{h as x}from"../chunks/SYLf1UDd.js";import{i as T}from"../chunks/BOyBYJ26.js";import{s as b}from"../chunks/CSyy-APr.js";import{i as B}from"../chunks/CioWWv__.js";import{b as n}from"../chunks/BKLqUiK9.js";import{n as E,b as L,p as A,w as o,A as R}from"../chunks/DzZ_TbVS.js";const C={content:`Hi, I'm <strong>Fabio Sales.</strong> I'm a designer and consultant with 20+ years of experience in project management, editorial design, and communication, specialized in infographics, data visualization, and digital narratives.
...
{imagem}
  ...
  tamanho: G
  classes: 
  tags: Art Direction, Design, Infographics
{}

Art direction, infographics, and page design for the book featuring the exclusive method <strong>'The Drummer’s Movement'</strong>, by André Polvo, teacher and drummer of Preta Gil, The Masked Singer Brazil, among others.
...
<strong>'Caro Leitor'</strong> and <strong>'Supercoluna'.</strong> A digital project focused on mobile distribution, delivering daily political coverage, analysis, and opinion for quick reading — with hyperlinks strategically embedded to guide you through the day’s top stories.
...
<strong>Economia Verde.</strong> Green hydrogen can replace oil and cut emissions. Demand is set to surge. And Brazil, rich in sun and wind, can lead. This explainer is part of a video series on the green economy.
...
<a href="https://infograficos.estadao.com.br/especiais/favela-amazonia/" target="_blank">Favela Amazônia: Portrait of a New Forest. </a> This series (printed and web version), which won the 2015 SIP Award (Sociedad Interamericana de Prensa – Inter American Press Association), explored the advance of urbanization in the Amazon, the growing influence of drug trafficking, and human rights violations in these regions.
...
<strong>Cronologia visual da copa de 2010.</strong> A five-page series that visually tells the story of the 2010 World Cup, forming a 1.5-meter-wide panel. Finalist for the <em>Esso Award</em> that year.

tags: Art Direction, Design, Infographics`,showInMenu:!0,menuLabel:"Works & Projects"},N={content:'embedWrapper: <script data-uva-id="16BCURvVTN5T-361PH0AIc9yeCZ8HyqiwtMoLSR8XEUo" src="https://arte.estadao.com.br/arc/scripts/uva-render-01.js"><\/script>',showInMenu:!1,menuLabel:""},O={content:'embedWrapper: <script data-uva-id="1l_jmg5YDdT1FSK12vozVnppMNU7bCPXmASJFl8Fi5Zs" src="https://arte.estadao.com.br/arc/scripts/uva-render-01.js"><\/script>',showInMenu:!1},U={content:'embedWrapper: <script data-uva-id="gz5oj3k2v9e3" src="https://arte.estadao.com.br/arc/scripts/uva-render-01.js"><\/script>',showInMenu:!1},X={content:"pdf: aitohtml.pdf",showInMenu:!1},F={content:"pdf: UvaPages.pdf",showInMenu:!1},H={content:"pdf: portfolio.pdf",showInMenu:!1,menuLabel:"Work"},G={content:`imagem: fabio_sales.png, PP
...
<strong>• Lecturer & Speaker: </strong>Past teaching roles at ESPM and Senac; invited speaker at SND and Malofiej conferences`,showInMenu:!0,menuLabel:"About"},W={content:"ai2html: timeline",showInMenu:!1,menuLabel:""},q={content:'embedWrapper: <script data-uva-id="1hmrQSCQHmvKXDWXthTyoGPtjIvTyogFNoOZmqPm2NDw" src="https://arte.estadao.com.br/arc/scripts/uva-render-01.js"><\/script>',showInMenu:!1,menuLabel:"Manual"},$={content:`embedWrapper: <script data-uva-id="1hmrQSCQHmvKXDWXthTyoGPtjIvTyogFNoOZmqPm2NDw" src="https://arte.estadao.com.br/arc/scripts/uva-render-02.js"><\/script>
...
{scrollerVideo}
 ...
 ease: 0.25
  {.passo}
    posicao: 0.10
    texto: Experiências imersivas no scroll
    classe: headline
  {}
  {.passo}
    posicao: 0.3
    texto: <span style='color: red'>Controle do vídeo pelo scroll</span>
    classe: sub
  {}
  {.passo}
    posicao: 0.90
    texto: Marcadores ajudam a posicionar textos
    classe: sub destaque
  {}
{}`,showInMenu:!1,menuLabel:""},J={index:C,placar:N,minhocao:O,rota_segura:U,ai2html:X,uvapages:F,portfolio:H,about:G,design_system:W,Teste:q,manual:$},V={BASE_URL:"./",DEV:!1,MODE:"production",PROD:!0,SSR:!1};var K=M('<link rel="preload" as="image"/>');function ie(D,k){var y;j(k,!1);const w=V&&!0;let i=v(""),m=v(""),g=v("");try{const d=((y=J.index)==null?void 0:y.content)||"",r=d?{orderedContent:String(d).split(/\n\n+/).map(s=>s.trim()).filter(Boolean)}:null,p=r?E(r):[],h=L(p);for(const s of h){const e=s.raw;if(typeof e=="object"&&(e.nome||e.imagem&&e.imagem.nome)){const a=A(e);if(a&&a.nome){const c=String(a.nome).replace(/\.(png|jpg|jpeg)$/i,"");if(w){const u=o(`/imgs/${c}.avif`,n),f=o(`/imgs/${c}.webp`,n);t(i,u||f||o(`/imgs/${a.nome}`,n))}else t(i,o(`/imgs/${a.nome}`,n));t(m,""),t(g,"(max-width: 860px) 100vw, 860px");break}}else if(typeof e=="string"&&/^imagem:/i.test(e)){const a=A(e);if(a&&a.nome){const c=String(a.nome).replace(/\.(png|jpg|jpeg)$/i,"");if(w){const u=o(`/imgs/${c}.avif`,n),f=o(`/imgs/${c}.webp`,n);t(i,u||f||o(`/imgs/${a.nome}`,n))}else t(i,o(`/imgs/${a.nome}`,n));t(m,""),t(g,"(max-width: 860px) 100vw, 860px");break}}}}catch{}B(),x(d=>{var r=S(),p=z(r);{var h=s=>{var e=K();_(()=>{b(e,"href",l(i)),b(e,"imagesrcset",l(m)),b(e,"imagesizes",l(g))}),I(s,e)};T(p,s=>{l(i)&&s(h)})}I(d,r)}),R(D,{get base(){return n}}),P()}export{ie as component};

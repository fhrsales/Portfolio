...
replace("<bullet texto='My Role' cor='var(--color-secondary)' /> I led the full <a href=\"https://www.estadao.com.br/infograficos/economia,multiplataforma-estadao-renova-e-aprimora-sua-versao-impressa,1199439?srsltid=AfmBOormT2t7Om421rKL3coAJ6rDGkuekNsMJBuO99BxeLVj6DLQAkkT\" target=\"_blank\">redesign strategy,</a> managing the intersection of editorial goals, industrial constraints, and commercial viability. This wasn't just a visual update; it was a business restructuring.", "<bullet texto='My Role' cor='var(--color-secondary)' /> I led the redesign strategy across visual language, information hierarchy, editorial needs, production constraints, and commercial viability. The output was not a collection of pages; it was a design system for a daily product operating at scale.");
...
A newspaper redesign can look like a graphic-design exercise. The real challenge was systemic: change a daily information product with a long-established identity while balancing readers, editorial priorities, industrial production, advertising, digital workflows, and business performance.

h3: The problem was larger than the page

Any visual decision affected how journalists structured stories, how editors expressed hierarchy, how pages moved through production, how advertising inventory worked, and how readers navigated a dense daily product. The design question became: <strong>how do you change the system without losing the trust encoded in the existing product?</strong>

h3: My role

I led the redesign strategy at the intersection of art direction, information architecture, editorial leadership, production constraints, and commercial viability. The job was not simply to define a visual style. It was to create rules a large multidisciplinary organization could use every day.

h3: From pages to a design system

A newspaper is a high-frequency interface. Every edition contains different content, but readers must understand the product immediately. The solution depended on reusable principles for hierarchy, typography, modular layouts, visual language, and recurring editorial patterns.
...
The redesign supported production optimization and a new advertising strategy. The business case associated with the project estimated a <strong>R$7 million increase in EBITDA in 2022</strong>.
...
Design leadership is not about controlling every output. It is about creating a system strong enough for many people to make good decisions inside it. That principle now shapes how I approach software products as well.
...
Automation is not the goal. The operating model deliberately separates repetitive questions from work that benefits from expertise. Digital channels can handle first-level service, stock and price checks, and order tracking; technical salespeople remain focused on tailored engineering solutions, consultative relationships, and strategic negotiations.
...
That is also the through-line in my career: <strong>understand complexity deeply enough to make the experience feel simple.</strong>
